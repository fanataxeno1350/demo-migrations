...
## Environments
- Preview: https://main--demo-migrations--fanataxeno1350.aem.page/
- Live: https://main--demo-migrations--fanataxeno1350.aem.live/
...
1. Open the `demo-migrations` directory in your favorite IDE and start coding :)
